...
<body>
    <div class="main-container">
		...
		<?php
                    echo '<div>';
                    echo "Click to join the chall";
                    echo '<form action="student_chall.php" method="post" style="display:inline;">';
                    echo '<button id = "edit_info" type="submit" >View chall</button>';
                    echo '</form>';
                    echo '</div>';
                ?>
            </div>
