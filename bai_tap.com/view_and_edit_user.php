...
if ($result->num_rows > 0) {
	...
	if($row["teacher"]){
		...
		if($username == $_SESSION['username']){
			...
			echo '<div>';
                	echo '<form action="edit_teacher_by_teacher.php" method="post" style="display:inline;">';
		...
		echo '</div>';
                ...
                echo '<div>';
                echo '<form action="remove_info_by_teacher.php" method="post" style="display:inline;">';
                echo '<button id = "edit_info" type="submit" >Remove</button>';
                echo '</form>';
                echo '</div>';
	}
    }
