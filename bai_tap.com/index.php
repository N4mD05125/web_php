        ...
        <div class="right-panel">
            ...
            if ($result->num_rows > 0) {
                while ($row = $result->fetch_assoc()) {
                    ...
                    echo '<form action="view_detail_student.php" method="post" style="display:inline;">';
                    echo '<button type="submit" name="student_id" value="' . htmlspecialchars($row["username"]) . '">View</button>';
                    echo '</form>';
                    echo '</div>';
                }
            } else {
